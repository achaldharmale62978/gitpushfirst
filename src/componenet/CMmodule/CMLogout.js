  ...
  return (
    <>
         <div className=' margin ' style={{ margin: '200px' }}>
                <center>
                    <div class="card " >
                        <h3 class="card-header fontfamily">Credit Manager Page </h3><br/>
                        ...
                        <div className=''>
                            ...
                            <NavLink to={'/cmpage'}><button type='reset' value='no' className='btn btn-outline-danger col-2 offset-1'>Cancel </button></NavLink>
