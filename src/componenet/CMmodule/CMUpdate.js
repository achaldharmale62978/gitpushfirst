...
const CMUpdate = () => {
    ...
    function savedata(data){
        axios.put(`http://localhost:5000/registeration`,data)
        navigate('/cmupdate')
        alert("CM registration is updated....")
    }
                        ...
                        <fieldset>
                            ...
                            <div className='g-5 display '>
                                <div className='form-group'>
                                    <label htmlFor='rid' className='fontsize'>ID</label>
